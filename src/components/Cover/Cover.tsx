            ...
            <div className="container">
                <div className="row align-items-lg-center">
                    <div className="col-lg-6 text-center order-lg-2">
                        <div className="templateux-block-play" onClick={showVideoModal}><span className="iconify" data-icon="bx:play"></span></div>
                        {videoModal ? (
                    ...
                    <div className="col-lg-6 order-lg-1">
                        ...
                        <p className='cov' data-aos="fade-up" data-aos-delay="200"><a href="#" className="btn btn-primary py-3 px-4">Free Download</a></p>
                    </div>
                </div>
            </div>
        </div>
