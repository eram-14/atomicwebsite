      ...
      <div className="templateux-section bg-light">
          <div className="container">
              <div className="row mb-5">
                  ...
                  <div className="col-md-4 mb-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                      <div className="media block-icon-1 d-block text-center">
                  ...
                  <div className="col-md-4 mb-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                      <div className="media block-icon-1 d-block text-center">
                  ...
                  <div className="col-md-4 mb-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                      <div className="media block-icon-1 d-block text-center">
                  ...
                  <div className="col-md-4 mb-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                      <div className="media block-icon-1 d-block text-center">
                  ...
                  <div className="col-md-4 mb-4 aos-init aos-animate" data-aos="fade-up" data-aos-delay="500">
                      <div className="media block-icon-1 d-block text-center">
              ...
              <div className="row">
                  <div className="col-md-12 text-center aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
